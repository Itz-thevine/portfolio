const expData = [
    ...
    {id: 4,
    firm: 'Quell Code',
    role: 'Front-End developer, HTML, CSS and JavaScript',
    period: 'JULY 2022 - NOVEMBER 2022',
    duties: ['Optimizing my design skills to create awesome user interface designs.', 'Writing clean and re-usable codes. ']
    },
    {id: 5,
    firm: 'HNGi9',
    role: 'Front-End intern',
    period: 'OCTOBER 2022 - PRESENT',
    duties: ['Working and delivering tasks on tight deadlines', 'Learning organizational workflow.', 'Connecting with techies of like minds.']
    },
];
